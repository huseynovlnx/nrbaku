 ...
 *
 * Təhlükəsizlik: yalnız düzgün `Authorization: Bearer <secret>`
 * başlığı olan sorğular qəbul edilir.
 */
...
async function cleanupOldBrowsingHistory(env) {
  ...
  while (hasMore) {
    ...
    deletedTotal += docNames.length;
  }

  console.log(`\${deletedTotal} köhnə gəzinti yazısı silindi.`);
}
